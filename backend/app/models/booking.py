...
class Booking(Base):
    ...
    number of trips: Mapped[int] = mapped_column(nullable=False)
    ...
    payment_status: Mapped[PaymentStatus] = mapped_column(SqlEnum(PaymentStatus), default=PaymentStatus.UNPAID, nullable=False)
